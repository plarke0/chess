...
public class ChessGame {
    ...
    public Collection<ChessMove> validMoves(ChessPosition startPosition) {
        ...
        if (movingPiece != null) {
            possibleMoves =  movingPiece.pieceMoves(this.board, startPosition);
        } else {
            return null;
        }
        ...
        for (ChessMove move : possibleMoves) {
            ...
            clonedBoard.addPiece(endPosition, movingPiece);

            if (!isBoardInCheck(pieceColor, clonedBoard)) {
                validMoves.add(move);
            }
        }
        return validMoves;
    ...
    private boolean isBoardInCheck(TeamColor teamColor, ChessBoard board) {
    ...
    public boolean equals(Object o) {
        ...
        return currentTeamColor == chessGame.currentTeamColor && Objects.equals(board, chessGame.board);
    }

    @Override
    public int hashCode() {
        return Objects.hash(currentTeamColor, board);
    }
}
